...
export interface StagedArtifactOptions {
  root: string;
  outputDirectory: string;
  relativeArtifact: string;
  render: (stagingOutputDirectory: string) => Promise<string>;
  validate: (stagedArtifact: string) => Promise<void>;
}
...
export async function stageAndPromoteArtifact(options: StagedArtifactOptions): Promise<string> {
