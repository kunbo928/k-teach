...
function errorPage(title        , detail        , nextAction        )         {
...
async function artifactEntries(teach                     , kind                  ) {
...
async function projectIndex(teaches                                )                  {
...
async function sendFile(root        , requestPath        , response                )                   {
...
export async function startPreviewRuntime(options                       )                          {
  ...
  const closeRuntime = (reason                               = "closed")                => {
...
//# sourceURL=k-teach/src/preview-runtime.ts